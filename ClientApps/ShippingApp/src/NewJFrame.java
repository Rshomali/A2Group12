                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jScrollPane4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 967, Short.MAX_VALUE)
                            .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 967, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if ( !connectError && !orderBlank )
        {
            try
            {
                ...
                sres = transactionManager.getOrder(Integer.parseInt(orderID));

                System.out.println("Size of all vector = " + sres.size());
                System.out.println("Size of first vector = " + sres.elementAt(0).size());
                System.out.println("Size of second vector = " + sres.elementAt(1).size());


                  //orderTable = sres.elementAt(0).elementAt(0);      // name of table with list of items
                  jTextField2.setText(sres.elementAt(0).elementAt(0)); // first name
                  jTextField3.setText(sres.elementAt(0).elementAt(1)); // last name
                  jTextField4.setText(sres.elementAt(0).elementAt(2)); // phone
                  jTextField5.setText(sres.elementAt(0).elementAt(3)); // order date
                  jTextArea2.setText(sres.elementAt(0).elementAt(4));  // address
                ...
                */
                ...
                {
                    msgString = i + ":  PRODUCT ID: " + sres.elementAt(i).elementAt(0) +
                         "  DESCRIPTION: "+ sres.elementAt(i).elementAt(1) + "  PRICE $" + sres.elementAt(i).elementAt(2);
                    jTextArea3.append(msgString + "\n");
                }
        ...
        if ( !connectError )
        {
            try
            {
               ...
               // rows = s.executeUpdate( SQLStatement );
                ...
                transactionManager.setOrderToShipped(updateOrderID, "test", "test");
    ...
    private void getPendingOrders() {
        ...
        if ( !connectError )
        {
            try
            {
                ...
                sres = transactionManager.getPendingOrders("test", "test");
                ...
                System.out.println("Size returned = " + sres.size());
    ...
    private void getShippedOrders() {
        ...
        if ( !connectError )
        {
            try
            {
                ...
                sres = transactionManager.getShipped();
